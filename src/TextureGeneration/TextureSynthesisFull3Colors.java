...
public class TextureSynthesisFull3Colors {
    // Amount of different tests it performs
    static int ITERATIONS = 10;
    static boolean DISPLAYMINCUT = false;
    static int scalingValue = 3;
    static int sizeOfSquare = scalingValue * 256;
    static String inputFilePath = "Resource/preTextureSynthesis/sandStepspreTS.jpg";
    static String outputFilePath = "Resource/postTextureSynthesis/sandSteps_3Col_3.jpg";
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 2304 --> 9 * 256
        BufferedImage output = new BufferedImage(2304, 2304, BufferedImage.TYPE_3BYTE_BGR);
        ...
        int greenX = random.nextInt(width - sizeOfSquare + 1);
        int greenY = random.nextInt(height - sizeOfSquare + 1);
        ...
        WritableRaster greenCorner = wrInput.createWritableChild(greenX, greenY, sizeOfSquare, sizeOfSquare, 0, 0, null);
        ...
        BufferedImage greenCornerImage = new BufferedImage(sizeOfSquare, sizeOfSquare, BufferedImage.TYPE_3BYTE_BGR);
        ...
        BufferedImage greenCornerImageScaled = new BufferedImage(sizeOfSquare / scalingValue, sizeOfSquare / scalingValue, BufferedImage.TYPE_3BYTE_BGR);

        redCornerImage.setData(redCorner);
        yellowCornerImage.setData(yellowCorner);
        greenCornerImage.setData(greenCorner);
        ...
        greenCornerImageScaled = scaling.filter(greenCornerImage, greenCornerImageScaled);
        ...
        WritableRaster greenScaled = greenCornerImageScaled.getRaster();


        ArrayList<BufferedImage> texture = new ArrayList<>();

        // iterate over every one of the possible 81 textls
        for (int i = 0; i < 81; i++) {
            ...
            if ((i / 27) % 3 == 1) {
                ...
                textlRaster.setRect(0, 0, getSpecificCorner(greenScaled, 2));
            } else {
            ...
            if ((i / 9) % 3 == 1) {
                ...
                textlRaster.setRect(128, 0, getSpecificCorner(greenScaled, 3));
            } else {
            ...
            if ((i / 3) % 3 == 1) {
                ...
                textlRaster.setRect(128, 128, getSpecificCorner(greenScaled, 0));
            } else {
            ...
            if (i % 3 == 1) {
                ...
                textlRaster.setRect(0, 128, getSpecificCorner(greenScaled, 1));
            } else {
        ...
        // change to [0-8] * 256
        // this isn't very pretty but there doesn't seem to be a formula behind the arrangement of tiles in the texture so it cant be done dynamically

        int textureSize = 256;
        wrOutput.setRect(0*textureSize, 8*textureSize, texture.get(0).getRaster());
        wrOutput.setRect(0*textureSize, 5*textureSize, texture.get(1).getRaster());
        wrOutput.setRect(5*textureSize, 8*textureSize, texture.get(2).getRaster());
        wrOutput.setRect(1*textureSize, 8*textureSize, texture.get(3).getRaster());
        wrOutput.setRect(3*textureSize, 5*textureSize, texture.get(4).getRaster());
        wrOutput.setRect(8*textureSize, 5*textureSize, texture.get(5).getRaster());
        wrOutput.setRect(4*textureSize, 8*textureSize, texture.get(6).getRaster());
        wrOutput.setRect(0*textureSize, 0*textureSize, texture.get(7).getRaster());
        wrOutput.setRect(3*textureSize, 0*textureSize, texture.get(8).getRaster());
        wrOutput.setRect(0*textureSize, 7*textureSize, texture.get(9).getRaster());
        wrOutput.setRect(2*textureSize, 8*textureSize, texture.get(10).getRaster());
        wrOutput.setRect(5*textureSize, 6*textureSize, texture.get(11).getRaster());
        wrOutput.setRect(1*textureSize, 5*textureSize, texture.get(12).getRaster());
        wrOutput.setRect(1*textureSize, 6*textureSize, texture.get(13).getRaster());
        wrOutput.setRect(8*textureSize, 2*textureSize, texture.get(14).getRaster());
        wrOutput.setRect(6*textureSize, 8*textureSize, texture.get(15).getRaster());
        wrOutput.setRect(5*textureSize, 3*textureSize, texture.get(16).getRaster());
        wrOutput.setRect(1*textureSize, 0*textureSize, texture.get(17).getRaster());
        wrOutput.setRect(4*textureSize, 7*textureSize, texture.get(18).getRaster());
        wrOutput.setRect(4*textureSize, 5*textureSize, texture.get(19).getRaster());
        wrOutput.setRect(7*textureSize, 4*textureSize, texture.get(20).getRaster());
        wrOutput.setRect(6*textureSize, 7*textureSize, texture.get(21).getRaster());
        wrOutput.setRect(6*textureSize, 5*textureSize, texture.get(22).getRaster());
        wrOutput.setRect(6*textureSize, 1*textureSize, texture.get(23).getRaster());
        wrOutput.setRect(6*textureSize, 0*textureSize, texture.get(24).getRaster());
        wrOutput.setRect(2*textureSize, 2*textureSize, texture.get(25).getRaster());
        wrOutput.setRect(4*textureSize, 0*textureSize, texture.get(26).getRaster());
        wrOutput.setRect(3*textureSize, 8*textureSize, texture.get(27).getRaster());
        wrOutput.setRect(3*textureSize, 7*textureSize, texture.get(28).getRaster());
        wrOutput.setRect(8*textureSize, 8*textureSize, texture.get(29).getRaster());
        wrOutput.setRect(0*textureSize, 6*textureSize, texture.get(30).getRaster());
        wrOutput.setRect(2*textureSize, 5*textureSize, texture.get(31).getRaster());
        wrOutput.setRect(4*textureSize, 3*textureSize, texture.get(32).getRaster());
        wrOutput.setRect(4*textureSize, 6*textureSize, texture.get(33).getRaster());
        wrOutput.setRect(7*textureSize, 2*textureSize, texture.get(34).getRaster());
        wrOutput.setRect(2*textureSize, 0*textureSize, texture.get(35).getRaster());
        wrOutput.setRect(1*textureSize, 7*textureSize, texture.get(36).getRaster());
        wrOutput.setRect(3*textureSize, 6*textureSize, texture.get(37).getRaster());
        wrOutput.setRect(6*textureSize, 3*textureSize, texture.get(38).getRaster());
        wrOutput.setRect(2*textureSize, 7*textureSize, texture.get(39).getRaster());
        wrOutput.setRect(2*textureSize, 6*textureSize, texture.get(40).getRaster());
        wrOutput.setRect(0*textureSize, 3*textureSize, texture.get(41).getRaster());
        wrOutput.setRect(6*textureSize, 6*textureSize, texture.get(42).getRaster());
        wrOutput.setRect(1*textureSize, 3*textureSize, texture.get(43).getRaster());
        wrOutput.setRect(7*textureSize, 8*textureSize, texture.get(44).getRaster());
        wrOutput.setRect(3*textureSize, 4*textureSize, texture.get(45).getRaster());
        wrOutput.setRect(4*textureSize, 2*textureSize, texture.get(46).getRaster());
        wrOutput.setRect(5*textureSize, 4*textureSize, texture.get(47).getRaster());
        wrOutput.setRect(1*textureSize, 4*textureSize, texture.get(48).getRaster());
        wrOutput.setRect(0*textureSize, 2*textureSize, texture.get(49).getRaster());
        wrOutput.setRect(2*textureSize, 3*textureSize, texture.get(50).getRaster());
        wrOutput.setRect(7*textureSize, 3*textureSize, texture.get(51).getRaster());
        wrOutput.setRect(0*textureSize, 1*textureSize, texture.get(52).getRaster());
        wrOutput.setRect(7*textureSize, 6*textureSize, texture.get(53).getRaster());
        wrOutput.setRect(5*textureSize, 7*textureSize, texture.get(54).getRaster());
        wrOutput.setRect(8*textureSize, 7*textureSize, texture.get(55).getRaster());
        wrOutput.setRect(5*textureSize, 0*textureSize, texture.get(56).getRaster());
        wrOutput.setRect(5*textureSize, 5*textureSize, texture.get(57).getRaster());
        wrOutput.setRect(1*textureSize, 2*textureSize, texture.get(58).getRaster());
        wrOutput.setRect(8*textureSize, 0*textureSize, texture.get(59).getRaster());
        wrOutput.setRect(6*textureSize, 4*textureSize, texture.get(60).getRaster());
        wrOutput.setRect(7*textureSize, 5*textureSize, texture.get(61).getRaster());
        wrOutput.setRect(5*textureSize, 1*textureSize, texture.get(62).getRaster());
        wrOutput.setRect(0*textureSize, 4*textureSize, texture.get(63).getRaster());
        wrOutput.setRect(2*textureSize, 4*textureSize, texture.get(64).getRaster());
        wrOutput.setRect(8*textureSize, 6*textureSize, texture.get(65).getRaster());
        wrOutput.setRect(8*textureSize, 1*textureSize, texture.get(66).getRaster());
        wrOutput.setRect(6*textureSize, 2*textureSize, texture.get(67).getRaster());
        wrOutput.setRect(3*textureSize, 2*textureSize, texture.get(68).getRaster());
        wrOutput.setRect(4*textureSize, 4*textureSize, texture.get(69).getRaster());
        wrOutput.setRect(3*textureSize, 3*textureSize, texture.get(70).getRaster());
        wrOutput.setRect(8*textureSize, 3*textureSize, texture.get(71).getRaster());
        wrOutput.setRect(8*textureSize, 4*textureSize, texture.get(72).getRaster());
        wrOutput.setRect(7*textureSize, 1*textureSize, texture.get(73).getRaster());
        wrOutput.setRect(1*textureSize, 1*textureSize, texture.get(74).getRaster());
        wrOutput.setRect(5*textureSize, 2*textureSize, texture.get(75).getRaster());
        wrOutput.setRect(7*textureSize, 7*textureSize, texture.get(76).getRaster());
        wrOutput.setRect(3*textureSize, 1*textureSize, texture.get(77).getRaster());
        wrOutput.setRect(2*textureSize, 1*textureSize, texture.get(78).getRaster());
        wrOutput.setRect(4*textureSize, 1*textureSize, texture.get(79).getRaster());
        wrOutput.setRect(7*textureSize, 0*textureSize, texture.get(80).getRaster());
